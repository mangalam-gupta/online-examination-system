...
<body style="background-color:#999797">
	...
	<div class="modal fade" id="loginModal">
		...
		<div class="col-md-10">
			...
			<br/>
			<br/>
			<span class="glyphicon glyphicon-user" style="font-size:22px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.facebook.com/mangalam.gupta.1" style="color:white"  target="_blank">Mangalam Gupta</a></span>
			<br/><br/><br/>
			<span class="glyphicon glyphicon-home" style="font-size:22px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.nitsikkim.ac.in" target="_blank" style="color:white" >NIT SIKKIM</a></span>
			<br/><br/><br/>
			...
			<hr>
			<div align="center">
				<a href="https://www.facebook.com/mangalam.gupta.1" class="fa fa-facebook" target="_blank"></a>
				<a href="https://twitter.com/mangalam_gupta" class="fa fa-twitter" target="_blank"></a>
				<a href="mailto:b150073ee@nitsikkim.ac.in" class="fa fa-google" target="_blank"></a>
				<a href="https://www.linkedin.com/in/mangalam-gupta-157514135" class="fa fa-linkedin" target="_blank"></a>
				<a href="https://www.instagram.com/mangalam_gupta_" class="fa fa-instagram" target="_blank"></a>
			</div>
			</div>
			</div>
			</div>
